...
export type EventKind = 'start' | 'intermediate-throw' | 'intermediate-catch' | 'boundary' | 'end';
/** Gateway variants. */
export type GatewayKind = 'exclusive' | 'parallel' | 'inclusive' | 'complex' | 'event-based' | 'event-based-parallel' | 'event-based-exclusive';
/** Marker glyphs drawn at the bottom-center of activities. */
export type ActivityMarker = 'sub-process' | 'loop' | 'parallel-mi' | 'sequential-mi' | 'compensation' | 'ad-hoc';
/**
...
export type BpmnEdgeKind = 'sequence-flow' | 'default-flow' | 'conditional-flow' | 'message-flow' | 'conversation-link' | 'association' | 'data-association';
