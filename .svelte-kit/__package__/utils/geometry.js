 ...
 */
export function waypointsToPath(points, cornerRadius = 5) {
    if (points.length === 0)
        return '';
    if (points.length === 1)
 ...
 * segment `from` → `tip`.
 */
export function arrowheadPoints(from, tip, length = 10, width = 7) {
